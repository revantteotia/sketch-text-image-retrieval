...
class ImgTextCompositionBase(torch.nn.Module):
  ...
  def __init__(self):
    ...
    self.normalization_layer = utils.loss_calculation.NormalizationLayer(
        normalize_scale=4.0, learn_scale=True)
    self.soft_triplet_loss = utils.loss_calculation.TripletLoss()
